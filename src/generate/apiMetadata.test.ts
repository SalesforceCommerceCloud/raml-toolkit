...
describe("ApiMetadata", () => {
  ...
  it("is created with no children", async () => {
    ...
    const testTree = new ApiMetadata("apis", path.join(tempDir.name, "apis"));
  ...
  it("is created with children", async () => {
    ...
    const child1 = new ApiMetadata("child1", path.join(tempDir.name, "child1"));
    const child2 = new ApiMetadata("child2", path.join(tempDir.name, "child2"));
